...
const product = [
    ...
    { id: "/dssp/sp6.html", image: "https://img.abaha.vn/photos/resized/320x/83-1575812225-myphamohui-lgvina.png", title: "Set Ohui chống lão hóa Age recovery", price_old: "3.100.000đ", price_current: "2.710.000", item_sold: "43 đã bán", brand: "Su:m37", origin_name:"Hàn Quốc", like:"Yêu thích", sale_off_percent: "10%", sale_off_label: "GIẢM",ngaydang:"2020-9-1" },
...
function getCurrentPage1(indexPage) {
...
function renderProduct(product) {
   var html = '';
    ...
    highlightText();
    product.sort(compareValues('price_current','desc'))
}
