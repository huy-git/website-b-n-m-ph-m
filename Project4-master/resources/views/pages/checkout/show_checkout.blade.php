    ...
    <div >
    	<div class="container checkout-form">
    		<div row class="check-out-adress">
    			...
    			<form action="{{URL::to('/save-checkout-customer')}}" method="POST">
    				...
    				<input class="form-control"  style="height: 30px;width: 400px;font-size: 18px;padding-left: 10px;margin-top: 5px;" type="text" name="shipping_name" placeholder="Họ và tên....."><br>
    				<input class="form-control"  style="height: 30px;width: 400px;font-size: 18px;padding-left: 10px;margin-top: 5px;" type="text" name="shipping_address" placeholder="Địa chỉ....."><br>
    				...
    				<textarea style="font-size: 18px;padding-left: 10px;width: 400px;" name="shipping_note"  placeholder="Ghi chú đơn hàng của bạn....." rows="16"></textarea><br>
    		
    				<input style="width: 400px;"  type="submit" value="Gửi" name="send_order" class="btn btn-danger btn-sm">
    			</form>
    		</div>
    						...
    						<div class="cart-item__content">
    							...
    							<div class="cart-item__flex">
    								<div class="cart-item-overview__product-name-wrapper">
    									<a href="" class="cart-item-overview__name"> Set kem mắt tái sinh Ohui The First Geniture Eye Cream Edition Grand Blue</a>
    								</div>
    								<div class="cart-item-overview__price">
    									<div class="cart-item__cell-unit-price">
    										<span class="cart-item__unit-price cart-item__unit-price--after js-cart-item-unit-price">4.140.000đ</span>
    									</div>
    							...
    							<div class="cart-item__cell-actions">
    								<button style="outline: none" ng-click="remove_cart(i.MaSP)" class="cart-item__action js-remove-cart">Xóa</button>
    							</div>
    						</div>
    					</div>
    				</div>
    			...
    			<div class="container ">
    				<div style="border: none" class="checkout">
    					<div class="cart-info">
    						...
    						<div class="cart-value">4.140.000đ</div>
    					</div>
    	...
    	<div class="container checkout-form">
    		...
    		<div class="checkout-payment-method-view__current checkout-payment-method-view__current-s">
    			<div class="checkout-payment-method-view__current-title checkout-payment-method-view__current-title-s">Thanh toán khi nhận hàng</div>
    		...
    		<div class="infor-content-header-infor">
    			<div class="infor-content-header-infor-item">
    				...
    				<div class="infor-content-header-infor-item-right">4.140.000đ</div>
    			</div>
    			<div class="infor-content-header-infor-item">
    			...
    			<div class="infor-content-header-infor-item">
    				...
    				<div class="infor-content-header-infor-item-right infor-content-header-infor-item-right--strong">4.140.000đ</div>
    			</div>
    		</div>

    		<div class="checkout">
    			<a href=" " class=" btn btn-back">Trở lại</a>
    			<a style="color: #fff" ng-click="checkOut()"  class=" btn btn--primary ">Thanh toán</a>
    		</div>
    	</div> --}}
    </div>
