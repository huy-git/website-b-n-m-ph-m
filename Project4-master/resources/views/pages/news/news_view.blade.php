...
<div>
    <div>
        ...
        <div class="app__container ">
            <div class="grid wide " style="height: 800px;">
               <div class="row" style="display: flex;">
                  <div class="col-sm-9 row" style="height: 600px;display: flex;">
                    @foreach($dnews as $val)
                    <div class="col-sm-4"  style="margin-top: 20px;" >
                        <img style="width:100%;height:160px;vertical-align: middle;" src="{{URL::to('public/uploads/news/'.$val->news_image)}}" alt="">
                        <a href="{{URL::to('details-news/'.$val->news_id)}}" style="font-size: 15px;color: black"><b><p style="margin-top: 10px;">{{$val->news_name}}</p></b></a>
                    </div>
                    @endforeach
                    
                </div>
                <div class="col-sm-3" style="height: 300px;">
                    <input style="font-size: 15px;" style="width:100%" type="text" name="" id="" class="form-control" placeholder="Nhập từ khóa...">
                    <div class="lienhe" style="margin-top:10px;">
                        <h1 style="font-size: 17px;"><b>DANH MỤC TIN TỨC</b></h1>
                        <ul>
                            <li style="font-size: 14px;">Về chúng tôi</li>
                            <li style="font-size: 14px;">Chăm sóc khách hàng</li>
                            <li style="font-size: 14px;">Khuyến mại</li>
                            <li style="font-size: 14px;">Sản phẩm mới</li>
                            <li style="font-size: 14px;">Tin tức - Sự kiện</li>
                        </ul>
