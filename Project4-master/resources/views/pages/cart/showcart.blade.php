                    ...
                    <nav class="nav__mobile-user ">
                        ...
                        <div class="nav__mobile-user-list ">
                            ...
                            <div class="nav__mobile-user-item nav__mobile-user-item--active ">
                                <a href="/Account/Login" class="nav__mobile-user-link ">Đăng nhậpp</a>
                            </div>
                        </div>
            ...
            <div class="col-sm-6" style="font-size: 18px;font-family: sans-serif;margin-left: 500px;border:1px solid gray;height: 280px; ">
                <div class="total_area" style="margin-top: 20px;">
                    <ul>
                     ...
                     <li style="background-color: #e3e3e3;height: 40px;line-height: 40px;padding-left: 20px">Tổng tiền <span style="margin-left: 270px">{{Cart::priceTotal().' '.'vnđ'}}</span></li>
                     <p></p>
                     ...
                     <p></p>
                     <li style="background-color: #e3e3e3;height: 40px;line-height: 40px;padding-left: 20px">Thành tiền <span style="margin-left: 250px">{{Cart::priceTotal().' '.'vnđ'}}</span></li>
                 </ul>
