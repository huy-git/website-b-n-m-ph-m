...
<div class="user-page-container container">
		...
		<div class="user-page-brief">
			...
			<div class="user-page-brief__right">
				<div class="user-page-brief__username">
					...
					@if($cus->customer_id==$val->customer_id)
					{{$cus->customer_name}}
					@endif
					@endforeach
					@endforeach
	...
	<div class="user-page__content">
		<div class="h25IfI">
			<div id="exTab1">
				<ul class="nav nav-pills tab_header container">
					...
					<li class="tab_list">
						<a href="#3a" data-toggle="tab">Xác nhận và giao hàng</a>
					</li>
					<li class="tab_list">
						<a href="#4a" data-toggle="tab">Đơn hàng đã hủy</a>
					</li>
		...
		<h4 style="padding-top: 20px;color: red;font-size: 25px;"><center>Danh sách đơn hàng đã và đang mua</center></h4>
			...
			<div class="tab-pane  active" id="1a">
				<div class="container-fluid mb-4 ttdh">		
					...
					<div class="tab-pane-title">
									...
									<div class="cart-page-shop-section__items">
										<div class="cart-item js-product-cart">
											...
											<div class="cart-item__content">
												...
												@if($data->product_id==$pro->product_id)
												<div class="cart-item__cell-overview">
													<a class="cart-item-overview__thumbnail-wrapper" href="">

														<img style="width: 100px;height: 100px" src="{{URL::to('public/uploads/product/'.$pro->product_image) }}">
												...
												<div class="cart-item__flex">
													<div style="height: 80px" class="cart-item-overview__product-name-wrapper">
														<a href="" class="cart-item-overview__name">{{$data->product_name}}</a>
												...
												<div class="cart-item__cell-actions">
													<span class="cart-item__unit-price cart-item__unit-price--after js-cart-item-unit-price text-danger">
														{{number_format($data->product_price)}}đ
													</span>
									...
									<div style="border: none" class="checkout">
										<div style="display: flex; align-items: flex-end" class="cart-info">
											...
											<div style="font-size: 30px; line-height: 100%" class="cart-value">
												{{$val->order_total}}đ</div>
											</div>
										</div>
										<nav class="navbar">
											<div class="container-fluid justify-content-end">
												@if($val->order_status==0)
												<a class="d-flex btn mr-3" style="background-color: orangered; color: #fff">Hủy đơn hàng</a>
												@else
												@endif
												<a href="{{URL::to('/chi-tiet-don/'.$val->order_id)}}" class="d-flex btn btn-d" style="border: 1px solid #e5e5e5">Chi tiết
												đơn hàng</a>
											</div>
										</nav>									
									</div>
						...
						@else
						<center><img  src="{{asset('public/img/donhang.png')}}"></center>
						<center>Bạn chưa mua sản phẩm nào của shop!</center>
						<center>Mời bạn hãy xem và mua sản phẩm <a href="{{URL::to('/')}}">tại đây :)</a></center>
				...
				<div class="tab-pane " id="2a">
					<div class="tab-pane-title ">
						...
						<div class="container-fluid mb-4 ttdh">		
							...
							<div class="tab-pane-title">
								<div class=" checkout-form">
									<div class="form-product" >
										@foreach($data_no as $val)
										<div class="cart-page-shop-section" style="margin-top: 20px;">
											<div class="cart-page-shop-section__items">
												<div class="cart-item js-product-cart">
													@foreach($order_details as $data)
													@if($val->order_id==$data->order_id)
										...
										<div class="container ">
											...
											<div style="border: none" class="checkout">
												...
												<nav class="navbar">
													<div class="container-fluid justify-content-end">
														<a href= "{{URL::to('/cancel-order/'.$val->order_id)}}" class="d-flex btn mr-3" style="background-color: orangered; color: #fff">Hủy đơn hàng</a>
														<a href="{{URL::to('/chi-tiet-don/'.$val->order_id)}}" class="d-flex btn btn-d" style="border: 1px solid #e5e5e5">Chi tiết
														đơn hàng</a>
													</div>
												</nav>									
					...
					<div class="tab-pane " id="3a">
						<div class="tab-pane-title ">
							Đơn hàng đã xác nhận và đang giao:
						</div>
						<div class="tab-pane-title">
							<div class=" checkout-form">
								<div class="form-product" >
									@foreach($data_yes as $val)
									<div class="cart-page-shop-section" style="margin-top: 20px;">
										<div class="cart-page-shop-section__items">
											<div class="cart-item js-product-cart">
												@foreach($order_details as $data)
									...
									<div class="form-product" >
										...
										<div class="container ">
											...
											<div style="border: none" class="checkout">
												...
												<nav class="navbar">
													<div class="container-fluid justify-content-end">
														<a href= "{{URL::to('/reset-order/'.$val->order_id)}}" class="d-flex btn mr-3" style="background-color: orangered; color: #fff">Đặt lại đơn hàng</a>
														<a href="{{URL::to('/chi-tiet-don/'.$val->order_id)}}" class="d-flex btn btn-d" style="border: 1px solid #e5e5e5">Chi tiết
														đơn hàng</a>
													</div>
												</nav>									
